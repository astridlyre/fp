...
const $20a167f96f72e1b2$var$isProduction = true;
const $20a167f96f72e1b2$var$prefix = 'Invariant failed';
function $20a167f96f72e1b2$export$f5708dca728d7177(condition, message) {
    if (condition) return;
    if ($20a167f96f72e1b2$var$isProduction) throw new Error($20a167f96f72e1b2$var$prefix);
    const provided = typeof message === 'function' ? message() : message;
    const value = provided ? `${$20a167f96f72e1b2$var$prefix}: ${provided}` : $20a167f96f72e1b2$var$prefix;
